/**
 * generators/frameworks/selenium-java/index.js
 * Clean generate(steps, opts) façade for the selenium-java framework.
 *
 * opts = {
 *   framework,        // always 'selenium-java'
 ...
 *
 * Returns {
 *   worldClass,       // SeleniumWorld.java content
